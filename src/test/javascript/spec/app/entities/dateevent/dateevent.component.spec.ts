...
import { DateeventComponent } from 'app/entities/dateevent/dateevent.component';
...
describe('Component Tests', () => {
    describe('Dateevent Management Component', () => {
        let comp: DateeventComponent;
        ...
        beforeEach(() => {
            TestBed.configureTestingModule({
                ...
                .overrideTemplate(DateeventComponent, '')
                .compileComponents();
        ...
        it('Should call load all on init', () => {
            ...
            expect(comp.dateevents[0]).toEqual(jasmine.objectContaining({ id: 123 }));
        });
