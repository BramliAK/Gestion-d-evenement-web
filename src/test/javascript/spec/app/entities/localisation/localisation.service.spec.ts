    ...
    describe('Localisation Service', () => {
        ...
        describe('Service methods', () => {
            ...
            it('should create a Localisation', () => {
                service.create(new Localisation(null)).subscribe(received => {
            ...
            it('should update a Localisation', () => {
                service.update(new Localisation(123)).subscribe(received => {
            ...
            it('should return a Localisation', () => {
            ...
            it('should return a list of Localisation', () => {
                ...
                const req = httpMock.expectOne({ method: 'GET' });
                req.flush([new Localisation(123)]);
            });
