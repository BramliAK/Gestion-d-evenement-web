    ...
    describe('Evenement Service', () => {
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/evenements';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });

            it('should create a Evenement', () => {
                service.create(new Evenement(null)).subscribe(received => {
            ...
            it('should update a Evenement', () => {
                service.update(new Evenement(123)).subscribe(received => {
